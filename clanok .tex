...
Základné informácie o grafickom jazyku, ktorý je použitý na modelovanie ako aj popis jeho diagramov sú v časti ~\ref{uml}.Príklady UML diagramov a ich vysvetlenie je v časti ~\ref{main}.  Záverečné poznatky a zhrnutie celého článku prináša časť ~\ref{zaver}.
...
Napriek tomu, aj dnes na webe narazíme na všelijaké pochybné názory\cite{PLP-Framework}. Dôležité veci možno \emph{zdôrazniť kurzívou}.
